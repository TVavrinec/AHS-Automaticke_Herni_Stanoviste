...
Ochrana přebití může nabíjení přerušit ještě ve chvíli kdy nabíječka nabijí a tedy signalisuje probíhající nabíjení.
Aby nedocházelo ke zmatení uživatele je krom přerušení nabíjení zastavena i signalizace která tak začne signalizovat dobitou baterii.

Původní verze správy napájení je vidět na obr\ref{fig:stary_PoverManager} (jde o o lehce upravené schéma ze kterého jsou některé části pro přehlednost odstraněny) 
\begin{figure}[h!]
    \centering
    \includegraphics[width=\textwidth]{text/PraktickaCast/img/stary_power_manager.png}
    \caption{Původní verze správy napájení}
...
Ve chvíli kdy se baterie dostala do stavu kdy bylo potřeba ji odpojit kontrola ji skutečně odpojila.
...
Behem této doby se nestihla vybít kapacita na napájecí větvi a zařízení s tak nestihlo plně vypnout.
Obvod tedy začal oscilovat dokud napětí na baterce nekleslo ještě víc aby se už znovu nezvedlo nad rozpoznávací úroveň čipu SL8261.
