...
\input{text/PraktickaCast/specifikace.tex}
...
\begin{refsection}
    \nocite{*}
    \printbibliography[type=online,title={Online články a dokomenty}]
    \printbibliography[type=manual,title={Katalogové listy duležitých součástek}]
\end{refsection}
