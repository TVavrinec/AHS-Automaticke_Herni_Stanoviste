...
%%% Abstrakt
\abstract[%
The aim of this work is to design an electronic device for use in outdoor games. 
Primarily the design of an automatic gaming station, but there has also been a design of a simple personal device. 
Emphasis is placed on the selection of appropriate systems for application in games and from these the design of electronics is based.
The design is divided into several groups, the design of the personal device and the design of the game station, which deals primarily with the design of the core but additional modules are also discussed.
]{%
...
Návrh je rozdělen do několika skupin, návrh osobního zařízení a návrh herního stanoviště, který se zabívá primárně návrhem jádra ale zmíní se i doplňkové moduly.
}
