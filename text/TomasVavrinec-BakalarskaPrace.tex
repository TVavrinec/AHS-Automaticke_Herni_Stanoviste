...
\input{nastaveni.tex}  % do tohoto souboru doplňte údaje o sobě, druhu práce, názvu...
...
\input{text/TeoretickyUvod/AplikaceHernichZarizeni/AHZUvod.tex}
\chapter{Požadavky na zařízení}
\input{text/TeoretickyUvod/AplikaceHernichZarizeni/Pozadavky.tex}
% \section{Základní řídící jednotka}
% \input{text/TeoretickyUvod/AplikaceHernichZarizeni/zakladAHS.tex}
\section{Moduly}
\input{text/TeoretickyUvod/AplikaceHernichZarizeni/Moduly.tex}
% \section{Dynamických zařízení}
% \input{text/TeoretickyUvod/AplikaceHernichZarizeni/Semi.tex}

%%% Vložení souboru 'text/vysledky' s popisem výsledků práce
% (rozdělte na více souborů či kapitol, pokud je vhodné)
\chapter{Návrh statického zařízení}
\input{text/PraktickaCast/navrhStatiky.tex}
\chapter{Návrh dynamického zařízení}
\input{text/PraktickaCast/navrhDynamiky.tex}
\chapter{Testování statického zařízení}
\input{text/PraktickaCast/testovaniStatiky.tex}
\chapter{Testování dynamického zařízení}
\input{text/PraktickaCast/testovaniDynamiky.tex}
